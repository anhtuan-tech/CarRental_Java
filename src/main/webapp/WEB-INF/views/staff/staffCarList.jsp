                    ...
                    <main class="mgmt-content">
                        <div class="admin-container">
                            ...
                            <div class="mb-6">
                                ...
                                <p class="text-muted text-sm">Review, verify registration specs, and approve vehicle partner applications.</p>
                            </div>
                            ...
                            <div class="action-bar"
                                 ...
                                 <div style="display:flex; align-items:center; gap:0.5rem;">
                                     <span class="text-xs text-muted" style="text-transform:uppercase; font-weight:600;">Status:</span>
                                     <select id="statusFilter" class="form-control" style="width:220px; height:42px; background:var(--color-dark-card); border-color:var(--color-dark-border); color:var(--color-white); border-radius:var(--radius-lg); padding:0 var(--space-3);">
                                         <option value="Pending_Approval">Pending Approval (Default)</option>
