...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Control Panel — Car Rental</title>
                    ...
                    <div class="db-welcome">
                        <div class="db-welcome-text">
                            ...
                            <p>Welcome back, <strong style="color:var(--orange);">
                                ...
                                </strong> — Platform operations &amp; personnel control center.</p>
                        </div>
                    </div>
                    ...
                    <div class="db-stats">
                        ...
                        <div class="stat-card">
                            ...
                            <div>
                                ...
                                <div class="stat-value">
                                    <c:choose>
                                        <c:when test="${not empty staffAccounts}">${staffAccounts}</c:when>
                                        <c:otherwise>0</c:otherwise>
                                    </c:choose>
                                </div>
                            </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div>
                                ...
                                <div class="stat-value">
                                    <c:choose>
                                        <c:when test="${not empty totalVehicles}">${totalVehicles}</c:when>
                                        <c:otherwise>0</c:otherwise>
                                    </c:choose>
                                </div>
                            </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div>
                                ...
                                <div class="stat-value">
                                    <c:choose>
                                        <c:when test="${not empty platformRevenue}">
                                            <fmt:formatNumber value="${platformRevenue}" type="number"
                                                              groupingUsed="true" /> ₫
                                        </c:when>
                                        <c:otherwise>0 ₫</c:otherwise>
                                    </c:choose>
                        ...
                        <div class="card-body">
                            <div style="position: relative; height: 350px;">
                                <div id="chartDataContainer"
                                     ...
                                     data-values='${monthlyBookingsJson}' style="display: none;"></div>
