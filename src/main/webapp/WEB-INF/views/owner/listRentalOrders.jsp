                            ...
                            <div class="admin-container">
                                ...
                                <div class="mb-6">
                                    <h1 class="hero-title"
                                        ...
                                        My Rental <span>Orders</span>
                                    </h1>
                                    <p class="text-muted text-sm">Monitor client requests and update car handover
                                        statuses.</p>
                                </div>
                                        ...
                                        <c:if test="${totalPages > 0}">
                                            <div class="pagination-wrapper"
                                                ...
                                                <div class="page-size-selector">
                                                    <form action="${pageContext.request.contextPath}/owner/orders"
                                                        method="get"
