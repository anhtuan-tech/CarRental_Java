...
<html lang="en">
    ...
    <head>
        ...
        <title>Checkout Summary & VNPAY Payment - Car Rental</title>
            ...
            <div class="container">
                <div class="checkout-card">
                    ...
                    <div class="summary-header text-center">
                        <h1
                            style="color: var(--color-white); font-size: 1.75rem; font-weight: 800; margin-bottom: 0.25rem;">
                            Reservation Checkout Summary
                        </h1>
                        <p style="color: var(--color-gray-light); font-size: 0.9rem;">
                            Review your reservation details before completing your secure payment.
                        </p>
                    </div>
                    ...
                    <div class="summary-grid">
                        <div class="summary-box">
                            ...
                            <span
                                style="font-size: 0.8rem; color: var(--color-gray-mid); font-family: monospace;">
                        ...
                        <div class="summary-box">
                            ...
                            <div class="summary-value">
                                <fmt:parseDate value="${startDateStr}" pattern="yyyy-MM-dd'T'HH:mm" var="sDate"
                                               type="both" />
                        ...
                        <div class="summary-box">
                            ...
                            <div class="summary-value">
                                <fmt:parseDate value="${endDateStr}" pattern="yyyy-MM-dd'T'HH:mm" var="eDate"
                                               type="both" />
                    ...
                    <div class="financial-receipt">
                        <h4
                            style="color: var(--color-white); font-size: 1.05rem; margin-bottom: 1rem; border-bottom: 1px solid var(--color-dark-border); padding-bottom: 0.5rem;">
                        ...
                        <div class="receipt-row">
                            ...
                            <span>
                                <fmt:formatNumber value="${subtotalFee}" type="number" groupingUsed="true" />
                                VND
                            </span>
                        </div>
                        ...
                        <div class="receipt-row">
                            ...
                            <span style="color: var(--color-gray-mid);">
                                <fmt:formatNumber value="${platformCommission}" type="number"
                        ...
                        <div class="receipt-row">
                            ...
                            <span style="color: var(--color-gray-mid);">
                                <fmt:formatNumber value="${ownerPayout}" type="number" groupingUsed="true" />
                                VND
                            </span>
                        </div>
