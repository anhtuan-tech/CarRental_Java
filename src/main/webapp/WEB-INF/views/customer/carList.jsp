    ...
    <body>
        ...
        <div class="page-wrapper">
            <div class="container mt-4">
                ...
                <!-- Header -->
                <div class="mb-6">
                    <h1 class="hero-title" style="font-size:2rem; margin-bottom: 0.5rem;">Choose <span>Your Car</span></h1>
                    <p class="text-muted text-sm">Discover the perfect vehicle for your next exceptional journey.</p>
                </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                if (queryInput)
                    queryInput.addEventListener('input', filterCars);
                if (typeSelect)
