...
<div class="page-wrapper">
    <div class="container mt-4">
        ...
        <p class="text-muted text-sm" style="margin-bottom: var(--space-4);">
            Category: <strong style="color:var(--color-blue-light);"><c:out value="${car.typeName}"/></strong>   License Plate: <c:out value="${car.licensePlate}"/>
        </p>
        ...
        <div class="detail-grid">
            ...
            <div>
                <div class="booking-panel">
                    ...
                    <p class="text-muted text-sm" style="margin-bottom: var(--space-8);">per calendar day</p>
                        ...
                        <c:when test="${not empty sessionScope.user}">
                            ...
                            <script>
                                (function() {
                                    ...
                                    if (sEl && !sEl.value) sEl.value = startIso;
                                    if (eEl && !eEl.value) eEl.value = endIso;
                                })();
                            </script>
                        </c:when>
                        <c:otherwise>
