...
<html lang="en">
    ...
    <head>
        ...
        <title>My Car Bookings - Car Rental</title>
    ...
    <body>
                ...
                <div class="bookings-container">
                    ...
                    <div class="mb-6">
                        <h1 class="hero-title"
                            ...
                            My Car <span>Bookings</span>
                        </h1>
                        <p class="text-muted text-sm">
                            Manage your upcoming trips and review past reservations.
                        </p>
                    </div>
        ...
        <div id="cancelModal" class="modal-overlay">
            <div class="modal-content">
                <h3 style="color: var(--orange); font-size: 1.25rem; margin-bottom: 0.75rem;">
                    Confirm Booking Cancellation
                </h3>
                <p
                    style="color: var(--text-body); font-size: 0.9rem; margin-bottom: 1rem; line-height: 1.5;">
                    Are you sure you want to cancel reservation for <strong id="cancelTargetCar"
                                                                            style="color: var(--text-primary);"></strong>?
                </p>

                <div
                    style="background: var(--info-bg); border: 1px solid rgba(59,130,246,0.2); border-radius: 8px; padding: 1rem; margin-bottom: 1.5rem; font-size: 0.85rem; color: var(--text-body);">
                    <i class="bi bi-info-circle-fill" style="color:var(--info);"></i> <strong style="color: var(--info);">VNPAY Automated Refund Policy:</strong>
                    <br />
                ...
                <form action="${pageContext.request.contextPath}/customer/bookings" method="post">
                    ...
                    <div style="display: flex; justify-content: flex-end; gap: 0.75rem;">
                        <button type="button" class="btn btn-outline" onclick="closeCancelModal()" style="border: 1px solid var(--border-dark); color: var(--text-body); background: transparent; padding: 0.5rem 1rem; border-radius: 6px; cursor: pointer;">
                            Keep Booking
                        </button>
                        <button type="submit" class="btn"
                                style="background: var(--orange); border-color: var(--orange); color: var(--white); padding: 0.5rem 1rem; border-radius: 6px; border: none; cursor: pointer;">
