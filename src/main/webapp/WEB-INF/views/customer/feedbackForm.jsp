...
<html lang="en">
    <head>
        ...
        <title>Submit Feedback - Car Rental</title>
        ...
        <div class="page-wrapper">
            <div class="container">
                ...
                <div class="feedback-form-card">
                    ...
                    <div class="mb-4">
                        <h1 class="hero-title" style="font-size: 1.75rem; margin-bottom: 0.5rem; text-align: left;">Write a <span>Review</span></h1>
                        <p class="text-muted text-sm">
                            How was your rental experience with the <strong style="color:var(--color-blue-light);"><c:out value="${car.brand}"/> <c:out value="${car.carName}"/></strong>?
                        </p>
                    </div>
                    <div class="blue-line" style="margin-bottom: 2rem;"></div>

                    <form id="feedbackForm" action="${pageContext.request.contextPath}/feedback?action=create" method="post" novalidate>
                        <input type="hidden" name="carId" value="${car.carId}"/>
                        <input type="hidden" name="bookingId" value="${bookingId}"/>
                        <input type="hidden" id="ratingInput" name="rating" value="<c:out value='${requestScope.ratingVal}'/>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <textarea id="comment"
                                          name="comment"
                                          class="form-control"
                                          placeholder="Write about your driving experience, vehicle condition, or transaction notes..."
                                          rows="6"
                                          style="resize:none; padding:var(--space-3);"
                                          required><c:out value='${requestScope.commentVal}'/></textarea>
                            </div>
                        ...
                        <div style="display:flex; gap:var(--space-4); margin-top:2rem;">
                            ...
                            <a href="${pageContext.request.contextPath}/cars?action=detail&amp;id=${car.carId}" class="btn btn-ghost">Cancel</a>
                        </div>
