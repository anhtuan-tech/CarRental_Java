...
<head>
    ...
    <title>Owner Login — CarRental</title>
...
<div class="auth-page">
    <div class="auth-visual">
        <div class="auth-visual-title">
            Owner Portal<br/><span>CarRental</span>
        </div>
...
<script>
    ...
    document.getElementById('ownerLoginForm').addEventListener('submit', function(e) {
        ...
        if (!email || !emailRx.test(email)) { e.preventDefault(); showToast('Please enter a valid email.', 'error'); return; }
