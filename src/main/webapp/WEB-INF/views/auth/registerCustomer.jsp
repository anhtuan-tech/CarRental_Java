        ...
        <div class="auth-page">
            ...
            <div class="auth-visual">
                ...
                <p class="auth-visual-subtitle">
                    Create your free account and unlock access to an exclusive fleet in just a few clicks.
                </p>
                <div class="auth-features">
                    <div class="auth-feature-item">
                        <div class="auth-feature-icon"><i class="bi bi-check-circle-fill"></i></div>
                        <span>Quick & seamless setup</span>
                    </div>
                    <div class="auth-feature-item">
                        <div class="auth-feature-icon"><i class="bi bi-car-front-fill"></i></div>
                        <span>Hundreds of premium models available</span>
                    </div>
                    <div class="auth-feature-item">
        ...
        <script>
            ...
            document.getElementById('registerForm').addEventListener('submit', function (e) {
                ...
                if (!phone || !phoneRx.test(phone)) {
                    e.preventDefault();
                    showToast('Invalid phone number (9-11 digits).', 'error');
                    return;
                }
